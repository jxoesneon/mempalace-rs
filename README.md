...
|--------------------|-------------------|---------|
| AAAK Compression   | ~1801 ops/sec     | 555 µs  |
| Entity Detection   | ~256796 ops/sec   | 4 µs    |
| Token Counting     | ~3593748 ops/sec  | 278 ns  |
| Compression Stats  | ~1226307 ops/sec  | 815 ns  |
<!-- BENCH_TABLE_END -->
