...
| **BABILONG  ** | 1.000 | Reasoning  | 557.0 ms |
...
|--------------------|-------------------|---------|
| AAAK Compression   | ~1830 ops/sec     | 546 µs  |
| Entity Detection   | ~259070 ops/sec   | 4 µs    |
| Token Counting     | ~3675347 ops/sec  | 272 ns  |
| Compression Stats  | ~1260117 ops/sec  | 794 ns  |
<!-- BENCH_TABLE_END -->
