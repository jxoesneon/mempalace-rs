...
|--------------------|-------------------|---------|
| AAAK Compression   | ~49,000 ops/sec   | ~20 µs  |
| Entity Detection   | ~196,000 ops/sec  | ~5 µs   |
| Token Counting     | ~5,400,000 ops/sec| ~186 ns |
| Compression Stats  | ~1,130,000 ops/sec| ~886 ns |
<!-- BENCH_TABLE_END -->
